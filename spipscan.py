...
def detect_sensitive_folders(url):
    folders = ['config/', 'IMG/' 'local/', 'prive/', 'config/ecran_securite.php']
...
parser.add_option('-w', '--website', help='Website to pentest', dest='website', default='http://localhost')
parser.add_option('-d', '--path', help='Path for webapp (default : "/")', dest='path', default='/')
parser.add_option('-t', '--themes', help='Detect themes installed', dest='detect_themes', default=False, action='store_true')
parser.add_option('-p', '--plugins', help='Detect plugins installed', dest='detect_plugins', default=False, action='store_true')
parser.add_option('-s', '--vulns', help='Detect possible vulns', dest='detect_vulns', default=False, action='store_true')
parser.add_option('-V', '--version', help='Detect version', dest='detect_version', default=False, action='store_true')
parser.add_option('-f', '--sensitive_folders', help='Detect sensitive folders', dest='detect_sensitive_folders', default=False, action='store_true')
parser.add_option('-u', '--users', help='Bruteforce user logins', dest='bruteforce_user_logins', default=False, action='store_true')
parser.add_option('-T', '--bruteforce_themes_file', help='Bruteforce theme file (eg. themes_name.db)', dest='bruteforce_themes_file', default=None)
parser.add_option('-P', '--bruteforce_plugins_file', help='Bruteforce plugin file (eg. plugins_name.db)', dest='bruteforce_plugins_file', default=None)
parser.add_option('-U', '--bruteforce_logins_file', help='Bruteforce login file (eg. user_logins.db)', dest='bruteforce_logins_file', default=None)
parser.add_option('-S', '--scan', help='Like -Vtps', dest='scan', default=False, action='store_true')
parser.add_option('-F', '--force', help='Force the scan if SPIP version is not detected', dest='force', default=False, action='store_true')
parser.add_option('-v', '--verbose', help='Verbose mode', dest='verbose', default=False, action='store_true')
